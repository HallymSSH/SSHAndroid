...
public class RouteActivity extends Activity {
    ...
    ArrayList<Double> cctvList = new ArrayList<>();
    ArrayList<Double> cctvList2 = new ArrayList<>();
    ...
    public void drawPedestrianPath() {
        ...
        // CCTV 위치 찾기
        db.searchCCTV(cctvList,cctvList2, point1.getLatitude(), point1.getLongitude(), point2.getLatitude(), point2.getLongitude());
